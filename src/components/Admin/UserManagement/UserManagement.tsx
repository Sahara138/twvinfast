  ...
  console.error("Failed to fetch users", error);
    ...
    return (
        <div className="min-h-screen overflow-hidden w-[53%] sm:w-[70%] md:w-[100%]">
            <main className=' main-container min-w-0'>
                <div className="md:flex items-start justify-between mb-8 border-b border-[#C4CDD5] ">

                    <Heading heading1="User Management" heading2="Manage team members, roles, and permissions" />

                    <button
                        onClick={() => setIsModalOpen(true)}
                        className="px-5 py-2 mb-5 md:mb-0 text-sm font-medium text-white bg-[#ED990B] rounded-lg hover:bg-orange-500 transition-colors"
                    >
                        Add User
                    </button>
                </div>
                ...
                <div className="md:flex gap-3 mb-6 ">
                    <div className="flex-1 relative  mb-3 md:mb-0">
                        ...
                        <input
                            ...
                            className=" pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-orange-200 focus:border-transparent outline-none transition-all"
                        />
                    </div>
                    <select
                        value={statusFilter}
                        onChange={(e) => setStatusFilter(e.target.value)}
                        className="px-4 py-2 border mr-2 md:mr-0 border-gray-300 rounded-lg focus:ring focus:ring-orange-200 focus:border-transparent outline-none transition-all bg-white"
                    >
                ...
                <div className="mb-6">
                    ...
                    {/* <div className="block w-full overflow-x-auto">
                        <div className="bg-white border border-gray-200 rounded-lg inline-block min-w-full align-middle">
                            <table className=" w-">
                                <thead className="bg-gray-50 border-b border-gray-200">
                                    <tr>
                                        <th className="text-left px-4 py-3 text-xs font-medium text-gray-600 uppercase tracking-wider">User</th>
                                        <th className="text-left px-4 py-3 text-xs font-medium text-gray-600 uppercase tracking-wider">Company</th>
                                        <th className="text-left px-4 py-3 text-xs font-medium text-gray-600 uppercase tracking-wider">Role</th>
                                        <th className="text-left px-4 py-3 text-xs font-medium text-gray-600 uppercase tracking-wider">Status</th>
                                        <th className="text-left px-4 py-3 text-xs font-medium text-gray-600 uppercase tracking-wider">Last Login</th>
                                        <th className="text-left px-4 py-3 text-xs font-medium text-gray-600 uppercase tracking-wider">Location</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-200">
                                    {filteredMembers.map((member) => (
