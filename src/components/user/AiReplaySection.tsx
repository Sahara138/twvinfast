    ...
    return (
        <div className='mt-6 p-6 border border-[#DFE3E8] rounded-lg shadow-sm'>
            ...
            <div className='bg-gray-50 p-5 rounded-lg mb-4 bg-gray-100'>
                ...
                <div className='space-y-3 text-gray-700 font-normal text-sm leading-relaxed'>
