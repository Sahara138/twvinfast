...
export function ForwardSection({ onClose }: { onClose: () => void }) {
    return (
        <div className='mt-12 px-[28px] pb-6 border border-[#DFE3E8] rounded-lg shadow-sm'>
            <div className='flex justify-between items-center'>
                <div className='flex items-center gap-x-2'>
                    <TfiBackRight size={24}/>
                    <div className='flex items-center'>
                        <h6 className="font-medium text-lg text-black01">To:</h6>
                        <input 
                            type='email' 
                            className='w-[500px] p-2 mb-4 rounded-lg focus:outline-none focus:border-transparent mt-4 text-sm font-normal'
            ...
            <div className='p-4 rounded-lg mb-4 text-sm font-normal text-gray-500'>
