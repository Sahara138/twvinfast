        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="pl-9 pr-3 py-2 border bg-[#F4F6F8] border-gray-200 rounded-md text-sm focus:outline-none focus:ring focus:ring-orange-100 w-60 xl:w-96"
            />
          </div>

          <select className="border border-gray-200 rounded-md text-sm px-3 py-2 text-gray-700 focus:ring focus:ring-orange-100">
